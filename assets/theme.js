...
function vue_esm_Vue(options) {
    if (false) {}
    this._init(options);
}
//@ts-expect-error Vue has function type
initMixin$1(vue_esm_Vue);
//@ts-expect-error Vue has function type
stateMixin(vue_esm_Vue);
//@ts-expect-error Vue has function type
eventsMixin(vue_esm_Vue);
//@ts-expect-error Vue has function type
lifecycleMixin(vue_esm_Vue);
//@ts-expect-error Vue has function type
renderMixin(vue_esm_Vue);
...
initGlobalAPI(vue_esm_Vue);
Object.defineProperty(vue_esm_Vue.prototype, '$isServer', {
    get: isServerRendering
});
Object.defineProperty(vue_esm_Vue.prototype, '$ssrContext', {
    get: function () {
        /* istanbul ignore next */
...
Object.defineProperty(vue_esm_Vue, 'FunctionalRenderContext', {
    value: FunctionalRenderContext
});
vue_esm_Vue.version = version;
...
vue_esm_Vue.config.mustUseProp = mustUseProp;
vue_esm_Vue.config.isReservedTag = isReservedTag;
vue_esm_Vue.config.isReservedAttr = isReservedAttr;
vue_esm_Vue.config.getTagNamespace = getTagNamespace;
vue_esm_Vue.config.isUnknownElement = isUnknownElement;
...
vue_esm_Vue.prototype.__patch__ = inBrowser ? patch : noop;
// public mount method
vue_esm_Vue.prototype.$mount = function (el, hydrating) {
...
if (inBrowser) {
    setTimeout(function () {
        if (config.devtools) {
            if (devtools) {
                devtools.emit('init', vue_esm_Vue);
            }
            else if (false) {}
        }
        if (false) {}
...
var mount = vue_esm_Vue.prototype.$mount;
vue_esm_Vue.prototype.$mount = function (el, hydrating) {
    el = el && query(el);
    /* istanbul ignore if */
...
vue_esm_Vue.compile = compileToFunctions;
...
const TOGGLE_RIGHT_DRAWER_EVENT = 'wetheme-toggle-right-drawer';
...
;// CONCATENATED MODULE: ./src/javascripts/global/fadeInUpAnimation.js
...
;// CONCATENATED MODULE: ./src/javascripts/global/Menu.js
...
class Menu {
  constructor(theme, element) {
    ...
    this.mainLinks.forEach(el => {
      el.addEventListener('mouseleave', () => this.hideDropdown());
    });
    ...
    if (this.megaMenu) {
      this.megaMenu.addEventListener('mouseleave', () => this.hideDropdown());
    }
  ...
  setDropdownOffset(el) {
    ...
    if (!dropdown) return;
    const navPosition = dropdown.getAttribute('data-logoPlacement');
    const subDropdown = dropdown.querySelector('.site-nav__subdropdown');
...
class Header extends Section_Section {
  ...
  constructor(theme, _element, pageLoad) {
    ...
    this.onSearch = e => {
      e.preventDefault();
      this.theme.toggleRightDrawer('search', true);
    };
    ...
    if (window.Shopify.designMode) {
      ...
      const overlayHeader = this.element.dataset.headerOverlay;
      document.addEventListener('shopify:inspector:activate', this.onInspectorActivate.bind(this, headerEl, overlayHeader));
      document.addEventListener('shopify:inspector:deactivate', this.onInspectorDeactivate.bind(this, headerEl, overlayHeader));
    }
    this.handleStickyHeaderVars();
  ...
  onInspectorActivate(headerEl, overlayHeader) {
    // Disable sticky header
    this.element.setAttribute('data-inspector-active', 'true');
    const headerWrapper = this.element.closest('.shopify-section');
    if (this.element.dataset.headerSticky === 'true') headerWrapper.classList.remove('sticky-header');

    // Disable overlay header
    if (overlayHeader == 'true') {
      this.element.classList.remove('overlay-header-wrapper');
      if (headerEl) headerEl.classList.remove('overlay-header');
    }
  }
  onInspectorDeactivate(headerEl, overlayHeader) {
    // Re-enable sticky header
    this.element.setAttribute('data-inspector-active', 'false');
    if (this.element.dataset.headerSticky === 'true') this.loadStickyHeader();

    // Re-enable overlay header
    if (overlayHeader == 'true') {
...
;// CONCATENATED MODULE: ./src/javascripts/sections/AnnouncementBar.js

class AnnouncementBar extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/global/KenBurns.js
class KenBurns {
  /**
   * @param {import('../ThemeBase').default} theme
   * @param {HTMLElement} element
...
;// CONCATENATED MODULE: ./src/javascripts/sections/AnimatedText.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/CustomHtml.js

class CustomHtml extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/sections/Hero.js
...
const prototypes = {
  ...
  update,
  translate,
  transition: swiper_core_transition,
  slide,
  loop,
  grabCursor,
  events: events$1,
...
;// CONCATENATED MODULE: ./src/javascripts/sections/BlogPosts.js
...
class Parallax extends Component {
  ...
  */
  constructor(theme, element) {
    ...
    /** @type {Rellax[]} */
    this.init = () => {
      if (this.element.querySelector('.rellax')) {
        this.rellaxes = Array.prototype.map.call(this.element.querySelectorAll('.rellax'), el => {
          return new (rellax_default())(el, {
            center: true
          });
        });
      }
    ...
    this.destroy = () => {
      this.rellaxes.forEach(rellax => rellax.destroy());
      this.rellaxes = [];
    };
    this.isMobile = (breakpoint = null) => {
      return (breakpoint || this.theme.getBreakpoint()).order < Breakpoints.md.order;
    };
    this.onWindowResizeBreakpoint = ({
      breakpoint
    }) => {
      const isMobile = this.isMobile(breakpoint);
      if (!isMobile && this.rellaxes.length === 0) {
        // We're on desktop and parallax is not active => activate it
        this.init();
      } else if (isMobile && this.rellaxes.length > 0) {
        // We're on mobile and parallax is active => deactivate it
        this.destroy();
      }
    };
    this.rellaxes = [];
...
;// CONCATENATED MODULE: ./src/javascripts/sections/CollectionList.js


class CollectionList extends Section_Section {
  constructor(theme, element, pageLoad) {
    super(theme, element, pageLoad);
    this.parallax = new Parallax(theme, element.parentNode);
    this.theme.addBadges(this.element, 1000);
  }
}
;// CONCATENATED MODULE: ./src/javascripts/sections/EventsCalendar.js
...
class FeaturedCollection extends Section_Section {
  ...
  constructor(theme, element, pageLoad) {
    ...
    Array.prototype.forEach.call(element.querySelectorAll('.quick-add-button-variants'), shopNow => {
      if (shopNow) {
...
;// CONCATENATED MODULE: ./src/javascripts/sections/InteractiveMenu.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/ShopTheLook.js
...
class ShopTheLook extends Section_Section {
  constructor(theme, element, pageLoad) {
    ...
    this.handleShopNow = e => {
      e.preventDefault();
      window.wetheme.toggleRightDrawer('shop-now', true, {
        url: e.currentTarget.href
      });
    };
    this.attachEvents();
...
;// CONCATENATED MODULE: ./src/javascripts/sections/ImageWithTextSlideshow.js

class ImageWithTextSlideshow extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/sections/FooterNewsletter.js

class FooterNewsletter extends (/* unused pure expression or super */ null && (Section)) {}
;// CONCATENATED MODULE: ./src/javascripts/sections/ImageGallery.js
...
class ImageWithTextOverlay extends Section_Section {
  ...
  constructor(theme, element, pageLoad) {
    ...
    this.kenBurns = new KenBurns(theme, element);
    this.parallax = new Parallax(theme, element);
  }
}
;// CONCATENATED MODULE: ./src/javascripts/sections/ImageWithText.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/CollectionHeader.js
...
class CollectionHeader extends ImageWithText {
  ...
  constructor(theme, element, pageLoad) {
    super(theme, element, pageLoad);
    this.parallax = new Parallax(this.theme, this.element);
  }
}
;// CONCATENATED MODULE: ./src/javascripts/sections/LogoList.js
...
;// CONCATENATED MODULE: ./src/javascripts/modules/sectionLink.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/NavBanner.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/Newsletter.js

class Newsletter extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/sections/Password.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/MapSection.js
...
;// CONCATENATED MODULE: ./src/javascripts/global/Pagination.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/CollectionSection.js
...
class CollectionSection extends Section_Section {
  constructor(theme, element, pageLoad) {
    super(theme, element, pageLoad);
    this.initParallax = () => {
      // collection image is outside of main div, need to call it on parent
      this.parallax = new Parallax(this.theme, this.element.parentNode);
    };
    this.initPagination = () => {
      this.pagination = new Pagination_Pagination(this.theme, this.element, this.loadShopNow, this.loadQuickAdd);
    };
    this.loadShopNow = () => {
      Array.prototype.forEach.call(this.element.querySelectorAll('.quick-add-button-variants'), el => {
    ...
    document.addEventListener('shopify:section:select', this.initParallax);
    document.addEventListener('shopify:section:deselect', this.initParallax);
    document.addEventListener('shopify:section:reorder', this.initParallax);
  }
}
;// CONCATENATED MODULE: ./src/javascripts/sections/CollectionListSection.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/RichText.js

class RichText extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/sections/Testimonials.js

class Testimonails extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/sections/Blog.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/VideoHero.js
...
;// CONCATENATED MODULE: ./src/javascripts/sections/ScrollingBanner.js

class ScrollingBanner extends Section_Section {}
;// CONCATENATED MODULE: ./src/javascripts/global/Login.js
class Login {
  constructor(theme, element) {
...
var vue_class_component_esm_hasProto = fakeArray instanceof Array;
...
function vue_class_component_esm_isPrimitive(value) {
...
function componentFactory(Component) {
  ...
  var Super = superProto instanceof vue_esm_Vue ? superProto.constructor : vue_esm_Vue;
...
function forwardStaticMembers(Extended, Original, Super) {
  ...
  Object.getOwnPropertyNames(Original).forEach(function (key) {
    ...
    if (!vue_class_component_esm_hasProto) {
      ...
      if (!vue_class_component_esm_isPrimitive(descriptor.value) && superDescriptor && superDescriptor.value === descriptor.value) {
        return;
      }
...
function Emit(event) {
    return function (_target, propertyKey, descriptor) {
        ...
        descriptor.value = function emitter() {
            ...
            if (vue_property_decorator_isPromise(returnValue)) {
...
function vue_property_decorator_isPromise(obj) {
...
/**
  ...
  * @param {any[]} results
  */
let RightDrawer = (_dec = vue_class_component_esm({
  ...
  constructor(...args) {
    ...
    // /** @type {string} */
    _initializerDefineProperty(this, "languageUrl", _descriptor3, this);
  }
  data() {
    return {
      isOpen: false,
  ...
  /** @returns {import('../ThemeBase').default} */
  get theme() {
    // @ts-ignore
  ...
  toggle(type, forceOpen = undefined) {
    if (forceOpen === true) {
      this.type = type;
      this.open();
    } else if (forceOpen === false) {
  ...
  async fetchPage(url) {
    ...
    const pageContent = doc.querySelector('.page-main--wrapper');
    return pageContent;
  }
  ...
  async getProductPage(url) {
    try {
      ...
      if (!pageContent) {
        console.error("Fetched page content is undefined or null.");
        return;
      }
      const template = pageContent.querySelector('template[data-quick-view-product]');
      if (!template || !template.content) {
        console.error("Template or template content not found.");
        return;
      }
      const productDiv = template.content;

      // Ensure the target element exists
      const target = this.$refs.shopNowContent;
      if (!(target instanceof HTMLElement)) {
        console.error("Target element is not an HTMLElement.");
        return;
      }

      // Append child only if productDiv is a valid node
      if (productDiv instanceof Node) {
        target.appendChild(productDiv);
      } else {
        console.error("productDiv is not a valid Node.");
        return;
      }

      // window.Shopify.PaymentButton does not exist until the fetched
  ...
  clearSearchInput() {
    this.searchQuery = '';
    ( /** @type {HTMLElement} */this.$refs.searchText).focus();
  }
  get isSearchPredictive() {
    return this.isPredictive == 'true';
  }
  get searchUrlWithQuery() {
    if (this.isSearchPredictive) {
      return `${this.searchUrl}?q=${encodeURIComponent(this.searchQuery)}&resources[limit]=3&resources[limit_scope]=each`;
    } else {
      return `/search?q=${encodeURIComponent(this.searchQuery)}`;
    }
  }
  ...
  async performSearch() {
    ...
    let data;
    try {
      const response = await fetch(`${this.searchUrlWithQuery}`);
      if (!response.ok) {
        // FIXME handle error
      }
    ...
    // Loop over groups e.g. Products / Pages / Articles / Collections
    Object.keys(data.resources.results).forEach(resultType => {
      ...
      if (group.results && group.results.length > 0) {
        this.searchResultsNum += result.length;
        this.searchHasResults = true;
      }
    });
    if (!this.searchHasResults && this.searchQuery > '') {
      this.searchSummary = this.theme.translations.no_results_html.replace('{{ terms }}', this.searchQuery);
    }
    this.searching = false;
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "isPredictive", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "languageUrl", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  constructor(theme, element) {
    ...
    this.initPopup = () => {
      if (this.shouldShowPopup()) {
        const delay = this.testMode ? 0 : 1000 * this.popupDelay;
        setTimeout(() => {
...
;// CONCATENATED MODULE: ./src/javascripts/global/VerificationPopup.js
...
;// CONCATENATED MODULE: ./src/javascripts/global/Badge.js
...
;// CONCATENATED MODULE: ./src/javascripts/global/RecentlyViewed.js
...
class RecentlyViewed extends Section_Section {
  ...
  constructor(theme, element, pageLoad) {
    ...
    this.loadShopNow = () => {
      if (this.quickShopDesktopEnabled === 'true' || this.quickShopMobileEnabled === 'true') {
        const quickAddButtons = this.element.querySelectorAll('.quick-add-button-variants');
        quickAddButtons.forEach(button => {
          button.addEventListener('click', this.handleShopNow.bind(this));
        });
      }
    };
    this.handleShopNow = e => {
    ...
    this.quickShopDesktopEnabled = this.element.dataset.quickShopDesktopEnabled;
    this.quickShopMobileEnabled = this.element.dataset.quickShopMobileEnabled;
...
;// CONCATENATED MODULE: ./src/javascripts/global/InfoColumns.js
...
;// CONCATENATED MODULE: ./src/javascripts/global/SearchResults.js
...
class Theme extends ThemeBase {
  constructor() {
    ...
    this.loadGlobal = () => {
      ...
      vue_esm_Vue.config.ignoredElements = ['variant-dropdown'];
      vue_esm_Vue.directive('money', {
        bind: (el, binding) => {
          el.innerHTML = this.formatMoney(binding.value);
        },
        update: (el, binding) => {
      ...
      vue_esm_Vue.directive('responsive', {
        bind: (el, binding) => {
          /* Create product thumbnail:
           *  - Remove file extension, add _1000x, and re-add extension
          ...
          let srcset = '';
          if (el.width > 550) {
            srcset += binding.value.replace(/(\.[^.]*)$/, "_550x$1") + ' 550w,';
          }
          if (el.width > 1100) {
            srcset += binding.value.replace(/(\.[^.]*)$/, "_1100x$1") + ' 1100w,';
          }
          if (el.width > 1445) {
            srcset += binding.value.replace(/(\.[^.]*)$/, "_1445x$1") + ' 1445w,';
          }
          if (el.width > 1680) {
            srcset += binding.value.replace(/(\.[^.]*)$/, "_1680x$1") + ' 1680w,';
          }
          if (el.width > 2048) {
            srcset += binding.value.replace(/(\.[^.]*)$/, "_2048x$1") + ' 2048w,';
          }

          // Plus the original image size for good measure.
          srcset += binding.value + ' ' + el.width + 'w';
          const img = binding.value.replace(/(\.[^.]*)$/, "_1000x$1").replace('http:', '');
    ...
    /**
     * Load vue components in `element` tree
     *
     * @param {HTMLElement} element
     */
    ...
    /**
     * Load all instances of one vue component
     *
     * @param {HTMLElement} element Element which children should be searched for vue components
     * @param {string} tagName
     * @param {*} Component
     */
    this.loadVueComponent = (element, tagName, Component) => {
      Array.prototype.forEach.call(element.querySelectorAll(tagName), el => {
        const c = new vue_esm_Vue({
          el: el.parentNode,
          components: {
            [tagName]: Component
          },
  ...
  load() {
    ...
    // Right drawer is not part of any component
    this.loadVueComponent(document.body, 'wetheme-right-drawer', global_RightDrawer);
